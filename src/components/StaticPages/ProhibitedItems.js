...
const ProhibitedItems = () => {
  return (
    <div>
      <Helmet>
        <title>Prohibited Items - Boulder Bike Tour</title>
      </Helmet>
        ...
        <Card fluid>
          <Card.Content>
            ...
            <Card.Meta className="mb-3">
              In order to ensure the safety of all Boulder Bike Tour
              participants, spectators, and partners, BBT direction has added
              two categories of items to its list of prohibited objects at all
              race-week and race-day events. As always, all bags and items
              entering Boulder Bike Tour venues and events are subject to
              inspection by BBT direction, contracted private security
              personnel, venue personnel, and the Bouler Police Department.
            </Card.Meta>
            <Card.Description>
              The following items are prohibited from all BBT direction events
              and race venues:
              <ul>
                <li>
                ...
                <p />
                <li>
                  Photocopies or reproductions of Boulder Bike Tour runner bibs
                  or credentials
                </li>
              </ul>
              ...
              <p>
                ...
                medals will be denied to runners who do not display a race
                number.
              </p>
              <p>
                <strong>
                ...
                participant who does not wear his or her assigned race number
                and tag, or who is found to have transferred, bought, or sold
                entry into an BBT direction event, or otherwise permitted any
                other individual to wear his or her race number, will be
                disqualified and suspended from subsequent BBT direction events.{' '}
                <strong>
              ...
              <p>
                ...
                appreciated as we enhance and expand our security efforts to
                make your Boulder Bike Tour experience safe and enjoyable.
              </p>
            </Card.Description>
          </Card.Content>
        </Card>
